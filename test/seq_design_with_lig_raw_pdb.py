        ...
        for l_idx, f_ in enumerate(npy_list):
            ...
            if not f_.endswith('.npy'):
                ...
                try:
                    ...
                    features, lig_raw_dict, prot_raw_dict = get_pdbdata(npy_f, consider_lig=True, max_lig_num=max_lig_num)
                    ...
                    try:
                        ...
                        print(f"seq_mask pocket is not none")
                    except:
