#!/bin/bash
tm_raw="zero_with_0124_cluster_dict_b64_lr25_logit_mod"
...
MEM_CONFIG="/home/chenty/abacust_mem/src/scripts/configs/mem_config_logit_mod.yaml"
...
run_training() {
    local log_file="${LOG_DIR}/train_logit_mod_$(date +%F_%H-%M-%S).log"
