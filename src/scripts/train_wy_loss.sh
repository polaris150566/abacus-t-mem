#!/bin/bash
# ------------- 通用变量 -------------
tm_raw="zero_wy_loss_with_0124_cluster_dict_b64_lr25"
...
# ------------- 膜条件配置（纯 WY loss 加权，无膜信息，无 CFG）-------------
MEM_CONFIG="/home/chenty/abacust_mem/src/scripts/configs/mem_config_wy_loss_only.yaml"
...
chmod 444 "$EXP_DIR/experiment_config.yaml"
