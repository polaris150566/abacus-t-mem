#!/bin/bash
# ------------- AFDB 1:1 + 跨膜区 loss x1.5 (region_loss_weights) -------------
set -o pipefail
GPU=${GPU:-2}
tm_raw="zero_afdb_with_0124afdb_cluster_dict_1_1_b36_t0_tmw15"
...
run_training() {
      ...
      CUDA_VISIBLE_DEVICES=$GPU /home/chenty/miniconda3/envs/abacust/bin/fairseq-train \
            ...
            --tm_raw $tm_raw \
            --mem_config /home/chenty/abacust_mem/src/scripts/configs/mem_config_1_1_tmw15.yaml \
            2>&1 | tee -a "$log_file"
}
