...
tm_raw="zero_with_0124_cluster_dict_b64_lr25_logit_gate_decoder_pre_unified_theta_wy15_y16"
...
run_training() {
    ...
    local log_file="${LOG_DIR}/train_logit_gate_decoder_pre_unified_theta_wy15_y16_$(date +%F_%H-%M-%S).log"
