#!/bin/bash
tm_raw="zero_with_0124_cluster_dict_b64_lr25_logit_gate"
...
MEM_CONFIG="/home/chenty/abacust_mem/src/scripts/configs/mem_config_logit_gate.yaml"
...
run_training() {
    local log_file="${LOG_DIR}/train_logit_gate_$(date +%F_%H-%M-%S).log"
