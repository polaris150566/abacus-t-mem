...
CHECKPOINTS=(
  /home/chenty/abacust_mem/src/experiments/abacust_mem_zero_wy_loss_with_0124_cluster_dict_b64_lr25/checkpoints/checkpoint80.pt
  /home/chenty/abacust_mem/src/experiments/abacust_mem_zero_wy_loss_with_0124_cluster_dict_b64_lr25/checkpoints/checkpoint90.pt
  /home/chenty/abacust_mem/src/experiments/abacust_mem_zero_wy_loss_with_0124_cluster_dict_b64_lr25/checkpoints/checkpoint100.pt
)

TM_RAWS=(
  zero_wy_loss_with_0124_cluster_dict_b64_lr25
  zero_wy_loss_with_0124_cluster_dict_b64_lr25
  zero_wy_loss_with_0124_cluster_dict_b64_lr25
)
...
MEM_CONFIGS=(
  /home/chenty/abacust_mem/src/scripts/configs/mem_config_wy_loss_only.yaml
  /home/chenty/abacust_mem/src/scripts/configs/mem_config_wy_loss_only.yaml
  /home/chenty/abacust_mem/src/scripts/configs/mem_config_wy_loss_only.yaml
)
