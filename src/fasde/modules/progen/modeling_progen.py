...
class ProGenAttention(nn.Module):
    ...
    def forward(
        ...
        attn_output, attn_weights = self._attn(query, key, value, attention_mask, head_mask, mask_bias)
...
class ProGenModel(ProGenPreTrainedModel):
    ...
    def forward(
        ...
        if input_bias_layer < 0:
            input_bias_layer = self.n_layer + input_bias_layer
        ...
        #     hidden_states = hidden_states + input_bias
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if input_bias is not None and i == input_bias_layer:
                hidden_states = hidden_states + input_bias
            ...
            if (getattr(self.config, "gradient_checkpointing", False) or use_gradient_checkpoint) and self.training:
                # print(self.training)
                # print(f"use_gradient_checkpoint:{use_gradient_checkpoint}")
                ...
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        ...
                        return module(*inputs, use_cache, output_attentions, mask_bias=mask_bias)
...
class ProGenForCausalLM(ProGenPreTrainedModel):
    ...
    def forward(
        ...
        transformer_outputs = self.transformer(
            ...
            input_bias_layer=input_bias_layer,
