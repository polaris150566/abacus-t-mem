...
class ProteinMPNN(nn.Module):
    ...
    def nar_sample(self, X, S, mask, chain_M, residue_idx, chain_encoding_all,
        ...
        return_pdb_ctx_iter=-1, packing_only=False, noise_scale=1.0,
        ...
        # backbone_affine_tensor, backbone_angles_sin_cos = get_rigid_groups(X)
        # pdb_ctx_list = []
        # for return_iter_num in return_pdb_ctx_iter:
        #     pdb_ctx = make_pdb_ctx_from_design(iter_seq_list[return_iter_num], iter_torsion_list[return_iter_num], backbone_angles_sin_cos, backbone_affine_tensor)
        #     pdb_ctx_list.append(pdb_ctx)
