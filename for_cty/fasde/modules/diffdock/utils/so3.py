...
if os.path.exists(f'{cur_dir}/.so3_omegas_array2.npy'):
    _omegas_array = np.load(f'{cur_dir}/.so3_omegas_array2.npy')
    _cdf_vals = np.load(f'{cur_dir}/.so3_cdf_vals2.npy')
    _score_norms = np.load(f'{cur_dir}/.so3_score_norms2.npy')
    _exp_score_norms = np.load(f'{cur_dir}/.so3_exp_score_norms2.npy')
else:
    ...
    np.save(f'{cur_dir}/.so3_omegas_array2.npy', _omegas_array)
    np.save(f'{cur_dir}/.so3_cdf_vals2.npy', _cdf_vals)
    np.save(f'{cur_dir}/.so3_score_norms2.npy', _score_norms)
    np.save(f'{cur_dir}/.so3_exp_score_norms2.npy', _exp_score_norms)
